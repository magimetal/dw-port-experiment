...
def _summarize_step(session: MainLoopSession, *, save_path: Path | None, frame: str, action_kind: str, action_detail: str) -> dict[str, Any]:
    ...
    return {
        ...
        "attack": session.state.game_state.attack,
        "defense": session.state.game_state.defense,
        "more_spells_quest": session.state.game_state.more_spells_quest,
        ...
        "inventory_slots": list(session.state.game_state.inventory_slots),
