...
- Rows: 67
- Status counts: {"PASS": 65, "UNKNOWN": 2}
- Evidence tiers: {"checkpoint-proven": 1, "extractor-only": 55, "replay-proven": 1, "runtime-state": 8, "unknown": 2}
- All passed: False
...
| 61 | Stats | Shield-derived defense parity scope | fresh-game small-shield defense remains unresolved; Batch 3 proves weapon/armor/wearable recompute only and quarantines shield-derived defense until ROM-backed proof exists | UNKNOWN | unknown | engine/state.py canonical derived-stat helper + PARITY_REPORT.md scoped Batch 3 evidence | Observed fresh-game baseline keeps equipment_byte=0x02 with defense=2; shield-derived defense remains UNKNOWN until ROM-backed proof resolves the mismatch |
...
| 65 | Replay/Checkpoint | Replay executable fixture proof availability | representative executable replay fixtures prove overworld traversal, combat encounter resolution, and town purchase/stay flow | PASS | replay-proven | tests/replay/manifest.json + tests/replay/*.json + parity_proof.py | Bounded executable replay proof for current implemented overworld/combat/town behaviors |
| 66 | Replay/Checkpoint | Checkpoint executable fixture proof availability | representative executable checkpoint fixtures prove dungeon traversal resume and save/load resume continuity | PASS | checkpoint-proven | tests/checkpoints/manifest.json + tests/checkpoints/*.json + parity_proof.py | Bounded executable checkpoint proof for current implemented dungeon resume and canonical save/load continuity |
| 67 | Resistance Decode | ROM-backed resistance mapping availability | decoded resistance mapping present or explicit blocker surfaced | UNKNOWN | unknown | extractor/data_out/enemies.json | Resistance decode remains unresolved pending ROM-backed mapping |
